  ...
  function buildRoomRuleLines(options, gameKey) {
    if (String(gameKey ?? "").trim().toLowerCase() === MONOPOLY_GAME_KEY) {
      return [
        ...
        "จำนวนช่อง: 40 ช่อง | เงินตั้งต้น: ฿1,500 ต่อคน | ผ่าน GO รับ ฿200",
        ...
        "ถ้าเงินไม่พอซื้อหรือจ่ายหนี้ ให้ลดระดับสิ่งปลูกสร้าง ขายอสังหา หรือจำนองก่อน ระบบจะแนะนำเฉพาะปุ่มที่ทำได้จริง",
